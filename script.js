$(document).ready(function() {
	...
	var numBlocksArrayData6x = [  0, 28, 56, 84,112,140, 28, 56, 84,112,
							     28,  0, 28, 56, 84,112,140,112, 84];
	var numBlocksArrayData6y = [ 28,  0,  0,  0,  0, 28, 56, 56, 56, 56,
							    168,140,112,112,112,112,140,168,140];

	var numBlocksArrayData7x = [  0, 28, 56, 84,112,140, 28, 56, 84,112,
							      0,  0,  0, 28, 56, 84,112,140];
	var numBlocksArrayData7y = [ 28,  0,  0,  0,  0, 28, 56, 56, 56, 56,
	...
	console.log(elemRect.top);
			...
			// Level 1
			if (elemRect.top < -100 && elemRect.top > -1100 && $('#mindex1').css('display') === 'none') {
			...
			if (elemRect.top < -4300 && elemRect.top > -5300 && $('#mindex35').css('display') === 'none') {
			...
			if (elemRect.top < -5400 && elemRect.top > -6400 && $('#mindex36').css('display') === 'none') {
			...
			if (elemRect.top < -6500 && elemRect.top > -7500 && $('#mindex37').css('display') === 'none') {
			...
			// end Level 
			if (elemRect.top < -7300 && elemRect.top > -7500 && $('#mindex18').css('display') === 'none') {
				closeNum(numBlocksArray7, numBlocksArrayData7x, numBlocksArrayData7y);
    ...
    $(".menu").on("click","a", function (event) {
        ...
        top = $(id).offset().top + 600;  //узнаем высоту от начала страницы до блока на который ссылается якорь
